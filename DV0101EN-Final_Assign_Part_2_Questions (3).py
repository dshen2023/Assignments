...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemploy_eff= recession_data.groupby(['Vehicle_Type','unemployment_rate'])['Automobile_Sales'].mean().reset_index()
        R_chart4 = dcc.Graph(
            figure=px.bar(unemploy_eff,
                x='unemployment_rate',
                y='Automobile_Sales',
                title="Total Expenditure Share by Vehicle Type during Recessions"
                )
...
# Plot 2 :Total Monthly Automobile sales using line chart.
        # use groupby to create relevant data for plotting
        Monthly_sales = data.groupby('Month', sort=False)['Automobile_Sales'].sum().reset_index()                           
        Y_chart2  = dcc.Graph(
